            ...
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                ...
                <div class="app-modal-body">
                    ...
                    <div class="avatar av-l upload-avatar-preview chatify-d-flex"
                        style="background-image: url('{{ asset('storage/users-avatar') . '/' . (Chatify::getUserWithAvatar(Auth::user())->avatar ? Chatify::getUserWithAvatar(Auth::user())->avatar : 'avatar.png') }}');">
                        a</div>
