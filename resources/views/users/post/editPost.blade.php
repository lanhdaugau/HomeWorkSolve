                                                    ...
                                                    <div class="form-group">
                                                        <div id="image_preview" >
                                                            ...
                                                            <div class='img-div' id='img-div" + i + "'>
                                                                <img src='{{ asset('uploads/post/' . (empty($item->path_image ) ? '' : $item->path_image )) }}' class='img-responsive image img-thumbnail' >
                                                                <input type="checkbox" name="image[]" id="" value="{{$item->id}}"> </div> 
                                                            @endforeach
