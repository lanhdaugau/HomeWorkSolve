                        ...
                        <form class="settings-form" method="POST" action="{{ route('user.setting') }}"
                            ...
                            <div class="profile-picture">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                        <span class="btn btn-outline-default btn-file btn-round"><span
                                                class="fileinput-new">Sửa ảnh đại diện</span><span
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control border-input" disabled value="{{ $user->email }}"
                                    name="email">
                            </div>
                            <div class="form-group">
                                <label>Số điện thoại</label>
                                <input type="text" class="form-control border-input" value="{{ $user->phone }}"
                                    name="phone">
                            </div>
                            @error('phone')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                <label class="form-check-label">
                                    <input type="radio" name="gender" class="p-2 m-2" @checked($user->gender === 1 ? true : false)
                                        value="1">
                                    Nam
                                ...
                                <label class="form-check-label">
                                    <input type="radio" name="gender" class="p-2 m-2" @checked($user->gender === 0 ? true : false)
                                        value="0">
                                    Nữ
                                    <span class="form-check-sign"></span>
                                </label>
                            ...
                            <div class="">
                                <button type="submit" class="btn btn-wd btn-info btn-round"
                                    style="margin-left: 50%;transform: translateX(-50%)">Lưu</button>
                            </div>
                        </form>
