...
<link rel="stylesheet" href="{{asset('assets')}}/css/profile.css">
    <style type="text/css">
        ...
        .pic.stark {
            background-image: url('{{ asset('storage/users-avatar/' . (empty($user->avatar) ? 'avatar.png' : $user->avatar)) }}');
        }
    ...
    <div class="wrapper">
        ...
        <div class="profile-content section">
            <div class="container">
                ...
                <div class="name">
                    <h4 class="title text-center" style="text-align: center">{{ $user->name }}<br></h4>
                </div>
                <div class="row">
